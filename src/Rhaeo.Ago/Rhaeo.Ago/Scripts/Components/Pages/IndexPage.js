define(["require", "exports", "react", "./../Controls/Menu", "./../Controls/Composer", "./../Controls/NoteList", "./../../ActionCreators", "./../Controls/Navigation", "./TaskListPage"], function (require, exports, React, Menu_1, Composer_1, NoteList_1, ActionCreators_1, Navigation_1, TaskListPage_1) {
    "use strict";
    function getSelectedTab(props) {
        switch (props.selectedTab) {
            ...
            case "Tasks":
                return (React.createElement(TaskListPage_1.TaskListPage, {passphrase: props.passphrase, encryptAndSubmit: (draft, passphrase) => ActionCreators_1.encryptAndSubmit(draft, passphrase)}));
            case "Notifications":
