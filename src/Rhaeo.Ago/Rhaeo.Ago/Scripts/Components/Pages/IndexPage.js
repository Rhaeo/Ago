define(["require", "exports", "react", "./../Controls/Menu", "./../Controls/Composer", "./../Controls/NoteList", "./../Controls/Navigation"], function (require, exports, React, Menu_1, Composer_1, NoteList_1, Navigation_1) {
    "use strict";
    function getSelectedTab(props) {
        switch (props.selectedTab) {
            ...
            case "Tasks":
                return (React.createElement("div", null, React.createElement("h2", null, "Tasks"), React.createElement("ul", null)));
            case "Notifications":
                return (React.createElement("div", null, React.createElement("h2", null, "Notifications (", props.notifications && props.notifications.length, ") "), React.createElement("ul", null, props.notifications && props.notifications.map(function (n) { return (React.createElement("li", {key: n.message}, n.message)); }))));
        }
