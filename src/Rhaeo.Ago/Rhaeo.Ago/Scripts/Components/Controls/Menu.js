define(["require", "exports", "react", "./../../ActionCreators"], function (require, exports, React, ActionCreators_1) {
    ...
    exports.Menu = (props) => (React.createElement("div", {style: { background: "silver", display: "flex", padding: 5 }}, React.createElement("button", {onClick: handleImportClick, style: menuItemStyle}, "Import"), React.createElement("a", {href: "/Ago/Export", style: menuItemStyle}, "Export"), React.createElement("form", {action: "/Ago/Import", method: "post", encType: "multipart/form-data", style: { display: "none" }}, React.createElement("input", {onChange: handleImportFileChange, id: "importFileInput", name: "file", type: "file"}), React.createElement("input", {id: "importSubmitInput", type: "submit"})), React.createElement("button", {onClick: event => ActionCreators_1.navigateToItemListPage()}, "Items (", props.itemCount, ")"), React.createElement("button", {onClick: event => ActionCreators_1.navigateToTaskListPage()}, "Tasks (", props.taskCount, ")"), React.createElement("button", {onClick: event => ActionCreators_1.navigateToNotificationListPage()}, "Notificatons (", props.notificationCount, ")"), React.createElement("button", {onClick: event => ActionCreators_1.navigateToBudgetListPage()}, "Budgets")));
});
